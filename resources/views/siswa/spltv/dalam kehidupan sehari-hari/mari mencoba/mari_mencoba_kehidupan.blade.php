<div class="card shadow mb-4">
    <div class="card-body">
        @if (session('benar'))
            <div class="alert alert-dismissible fade show alert-success" role="alert">
                <form method="POST" target="_blank" rel="noreferrer noopener"
                    action="{{ route('spltv_kehidupan_2_pembahasan') }}">
                    @csrf
        ...
        <div class="row">
            <div class="col-1"></div>
            <div class="col">
                <p>Selesaikan Masalah di atas !</p>
            </div>
        </div>
    </div>
</div>
<form action="{{ route('spltv_kehidupan_2_post', $nomor) }}" method="POST">
    @csrf
    <input type="hidden" name="id" value="{{ $soal->id }}">
        ...
        <div class="card-body">
            <div class="tabel-responsive">
                <table class="table table-bordered table-hover" id="soal_1">
                    <thead>
                        <tr>
                            <td colspan="3">{{ $soal->pertanyaan_soal }}</td>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                <td id="jawaban_1">
                                    <input type="number" step="0.01" name="jawaban_1" class="form-control input-default"
                                        value="{{ old('jawaban_1') }}" placeholder="{{$soal->placeholder_1}}">
                                </td>
                            </tr>
                        @endif
                            ...
                            <tr>
                                <td id="jawaban_2">
                                    <input type="number" step="0.01" name="jawaban_2" class="form-control input-default"
                                        value="{{ old('jawaban_2') }}" placeholder="{{$soal->placeholder_2}}">
                                </td>
                            </tr>
                        @endif
                            ...
                            <tr>
                                <td id="jawaban_3">
                                    <input type="number" step="0.01" name="jawaban_3" class="form-control input-default"
                                        value="{{ old('jawaban_3') }}" placeholder="{{$soal->placeholder_3}}">
                                </td>
                            </tr>
                        @endif
                    </tbody>
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <a href="{{ route('spltv_kehidupan_2', [$soal->id, $nomor]) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" target="_blank" rel="noreferrer noopener" action="{{route('spltv_kehidupan_2_pembahasan')}}">
                        @csrf
                        <input type="hidden" name="id" value="{{ $soal->id }}">
                        <input type="hidden" name="nomor" value="{{ $nomor }}">
