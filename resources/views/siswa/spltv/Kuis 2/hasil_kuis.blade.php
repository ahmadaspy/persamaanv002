...
@section('title')
    Hasil kuis kontekstual SPLTV {{Auth::user()->name}}
@endsection
@section('content')
    <div class="card">
        <div class="card-body">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <p class="card-text text-center">Nilai Kamu : {{ $nilai->nilai }}</p>
                            <p class="card-text text-center">Pelajari lagi materi sebelumnya klik <a href="{{route('spltv_kehidupan_1')}}" class="text-warning stretched-link">disini</a></p>
                            <a href="{{ route('kuis_index2_page') }}" class="btn btn-danger">Ulang kuis</a>
                        @endif
                    </div>
