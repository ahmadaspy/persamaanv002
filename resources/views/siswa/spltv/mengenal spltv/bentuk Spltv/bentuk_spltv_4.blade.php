                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <p>salah satu persamaan di dalam sistem persamaan linear membentuk seperti
                                                dibawah :
                                                <br>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card" style="background-color: #e3e3e3">
                                                <div class="card-body">
                                                    Bentuklah bidang dalam grafik 3 dimensi menggunakan geogebra di bawah dengan persamaan \(4x+2y+z=8\) !
                                                </div>
                                            </div>
                                            <div class="card" style="background-color: #e3e3e3">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p>
                                                                kita bisa memisalkan angka variabel apa saja, dengan memisalkan \(y = 0\) dan \(z = 0\) maka kita mendapatkan titik di sumbu \(x\) yang dilalui oleh persamaan \(4x+2y+z=8\)
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <p>
                                                        \(4x+2y+z=8\) <br>
                                                        \(4x+\) <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> + <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> = \(8\) <br>
                                                        \(4x=8\) <br>
                                                        \(x =\) <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> <br>
                                            ...
                                            <div class="card" style="background-color: #e3e3e3">
                                                ...
                                                <div class="card-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p>
                                                                memisalkan \(x = 0\) dan \(z = 0\) maka kita mendapatkan titik di sumbu \(y\) yang dilalui oleh persamaan \(4x+2y+z=8\)
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <p>
                                                        \(4x+2y+z=8\) <br>
                                                        <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;">  \(+2y+\)  <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> = \(8\) <br>
                                                        \(2y=8\) <br>
                                                        \(y =\) <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> <br>
                                                        titik yang berada di sumbu x adalah \((0,4,0)\)
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="card" style="background-color: #e3e3e3">
                                                <div class="card-header">
                                                    <h6>2. Menentukan titik di sumbu \(z\) yang dilalui persamaan</h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p>
                                                                memisalkan \(x = 0\) dan \(y = 0\) maka kita mendapatkan titik di sumbu \(y\) yang dilalui oleh persamaan \(4x+2y+z=8\)
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <p>
                                                        \(4x+2y+z=8\) <br>
                                                        <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;">  \(+\)  <input type="number" name="" id="" style=" border-radius: 6px; border: 1px solid #ccc; width: 40px;"> \(+z\) = \(8\) <br>
                                                        \(z=8\) <br>
                                                        titik yang berada di sumbu x adalah \((0,0,8)\)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
