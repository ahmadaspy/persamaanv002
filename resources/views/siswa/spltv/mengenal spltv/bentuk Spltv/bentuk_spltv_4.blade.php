                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card" style="background-color: #e3e3e3">
                                            <div class="card-body">
                                                Bentuklah bidang dalam grafik 3 dimensi menggunakan geogebra di bawah
                                        ...
                                        <div class="card" id="card_2"
                                            ...
                                            <div class="card-body">
                                                ...
                                                \(4x+2y+z=8\) <br>
                                                <input type="number" name="" id="step_1_1_3" onchange="step_1_1(3)"
                                                    style=" border-radius: 6px; border: 1px solid #ccc; width: 40px; text-align: center;">
                                        ...
                                        <div class="card" id="card_3"
                                            ...
                                            <div class="card-body">
                                                ...
                                                \(4x+2y+z=8\) <br>
                                                <input type="number" name="" id="step_1_1_6" onchange="step_1_1(6)"
                                                    style=" border-radius: 6px; border: 1px solid #ccc; width: 40px; text-align: center;">
