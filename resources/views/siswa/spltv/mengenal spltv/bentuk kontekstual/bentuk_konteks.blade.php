                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-halaman-pengertian">
                                <tr>
                                    <td>
                                        <img src="{{ asset('image/petunjuk/Sistem persamaan linear tiga variabel/termasuk atau tidak termasuk.jpg') }}"
                                            alt="petunjuk 1" class="img-fluid">

                                    </td>

                                    <td>
                                        <p>Pada tombol termasuk dan tidak termasuk akan berwarna hijau atau merah yang menandakan
                                        </p>
