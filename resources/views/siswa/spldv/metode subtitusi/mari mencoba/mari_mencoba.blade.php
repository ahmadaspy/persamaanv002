        ...
        @if (session('benar'))
            <div class="alert alert-dismissible fade show alert-success" role="alert">
                <form method="POST" target="_blank" rel="noreferrer noopener"
                    action="{{ route('pembahasan_spldv_subtitusi') }}">
                    @csrf
...
<form action="{{ route('spldv_subtitusi_2_post', $nomor) }}" method="POST">
    @csrf
    <input type="hidden" name="id" value="{{ $soal->id }}">
        ...
        <div class="card-body">
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <a href="{{ route('spldv_subtitusi_2', [$soal->id, $nomor]) }}"
            ...
            <div class="row align-item-center">
                <div class="col text-center">
                    ...
                    @foreach ($soal_all as $all)
                        <a href="{{ route('spldv_subtitusi_2', [$all->id, $no]) }}"
