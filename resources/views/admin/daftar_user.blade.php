                            ...
                            <tr>
                                <td>
                                    @if ($users->photo_profile)
                                        <img src="{{ asset($users->photo_profile) }}" class=" rounded-circle mr-3" alt=""
                                            style="width: 40px">
                                    @else
                                        <img src="{{ asset('profile_image/default.png') }}" class=" rounded-circle mr-3"
                                ...
                                <td>
                                    <span @if ($users->roles[0]->name == 'admin') class="badge badge-primary" @endif
                                        @if ($users->roles[0]->name == 'guru') class="badge badge-success" @endif
